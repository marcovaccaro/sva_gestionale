...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
        	<h1 class="page-header">Upload Appuntamenti <small>(Excel CRM Oksana<!--small>Mese di produzione: <? echo MESE_CORRENTE ;?></small-->)</small></h1>
        </div><!-- /.col-lg-12 -->
		...
		<div class="col-lg-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Carica il file (deve essere .xls)
						</div>
...
?>
	...
	<form action="0002_upload_appuntamenti_sva.php" method="post" enctype="multipart/form-data">   
		<fieldset>
			<!---- serviva a scegliere il mese ---- div class="form-group">
